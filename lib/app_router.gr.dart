...
class ActionChooserRoute extends _i8.PageRouteInfo<void> {
  const ActionChooserRoute({List<_i8.PageRouteInfo>? children})
    : super(ActionChooserRoute.name, initialChildren: children);

  static const String name = 'ActionChooserRoute';

  static _i8.PageInfo page = _i8.PageInfo(
    name,
    builder: (data) {
      return const _i1.ActionChooserPage();
    },
  );
}
...
/// generated route for
/// [_i5.JobChooserPage]
class JobChooserRoute extends _i8.PageRouteInfo<void> {
  const JobChooserRoute({List<_i8.PageRouteInfo>? children})
    : super(JobChooserRoute.name, initialChildren: children);

  static const String name = 'JobChooserRoute';

  static _i8.PageInfo page = _i8.PageInfo(
    name,
    builder: (data) {
      return const _i5.JobChooserPage();
    },
  );
}
...
class RecordsRoute extends _i8.PageRouteInfo<void> {
  const RecordsRoute({List<_i8.PageRouteInfo>? children})
